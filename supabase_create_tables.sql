-- MevzuatGPT Supabase Database Setup (Düzeltilmiş Boyut: 1536)
-- Bu SQL scriptini Supabase Dashboard -> SQL Editor'da çalıştırın

-- 1. Gerekli extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS vector;

-- 2. User profiles tablosu (Auth ile entegre)
...
-- 4. Embeddings tablosu (1536 dimension - PostgreSQL ivfflat limit uyumlu)
...
-- 8. Otomatik trigger fonksiyonları
...
-- 10. Performance indexes (1536 dimension uyumlu)
